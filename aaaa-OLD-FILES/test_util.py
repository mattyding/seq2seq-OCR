...
test_util.py
-------------
This program contains utility functions for testing the trained model.

TODO: figure out how to OOP the model
"""
import sys
import os
import pathlib
...
#sys.path.append(os.getcwd() + "/model_v2/")
#sys.path.append(os.getcwd())
from ..seq2seqOCR import settings
from ..model_v2 import process_coha
...
def init_english_set() -> set:
    """
    Prepares hashset of English words
    """
    english_words = set()
...
def decode_sequence(input_seq):
    """
    Evaluates trained seq2seq model on input vectors.
    """
...
def run_model_v2():
    """
    Evaluates Model 2 - Only Noisy Text
    """
